 ...
 */
final class Version20201231133602 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE apprenant (id INT AUTO_INCREMENT NOT NULL, groupe_id INT DEFAULT NULL, INDEX IDX_C4EB462E7A45358C (groupe_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
